...
import fr.dauphine.ja.M1MiageApp.projet.MorpionSolitairePanel.State;
                ...
                switch (gameState) {
                    ...
                    case HUMAN:
                        if (SwingUtilities.isRightMouseButton(e))
                            ...
                            Grid.Result res = grid.playerMove(e.getX(), e.getY(), playerScore + 1);
                ...
                while (true) {
                    try {
                        if (gameState == State.BOT) {
                            ...
                            grid.computerMove(move.y, move.x, botScore + 1);
